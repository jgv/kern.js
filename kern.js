...
function kern() {
	...
	thePanel =
		['<style>',
			...
			'.kernjs_panel { position: relative; z-index: 1000000000; text-align: center; height: 40px; width: 100%; margin: 0 auto; background: -moz-linear-gradient(top, #45484d 0%, #000000 100%); background: -webkit-gradient(linear, left top, left bottom, color-stop(0%,#45484d), color-stop(100%,#000000));}',
